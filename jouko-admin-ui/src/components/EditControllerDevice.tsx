...
interface EditControllerDeviceProps {
...
export class EditControllerDevice
    extends React.Component<EditControllerDeviceProps, EditControllerDeviceState> {
    constructor(props: EditControllerDeviceProps) {
        super(props);
        this.state = {
            eui: '',
            key: '',
